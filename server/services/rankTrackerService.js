...
//Serach google for a keyword and extract ranking for a target domain
    ...
    try{
        ...
        // Initial Google visit & Consent Handling
            ...
            // Page extraction: Retry up to 3 times if results are missing
                ...
                // Result Synthesis: Update global results and checks for target match
                for(const r of pageResults){
                    r.position = allResults.length + 1;
                    allResults.push(r)
                    if(!found && (r.domain.toLowerCase().includes(cleanTarget)
