...
import { SearchIcon, GlobeIcon, FileSearchIcon, BrainIcon,
     CheckCircleIcon, AlertCircle, Loader2, ArrowRightIcon } from "lucide-react";
...
export default function Analyze() {
    ...
    const handleAnalyze = async (submitUrl?: string) => {
        ...
        try{
            ...
            setError(err.response?.data?.message || err.message || "Failed to start anaysis");
            setAnalyzing(false);
        }
    };
